...
import OOP_dz_5.models.TableModel;
import OOP_dz_5.presenters.BookingPresenter;
import OOP_dz_5.presenters.Model;
import OOP_dz_5.presenters.View;
import OOP_dz_5.views.BookingView;
...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        bookingView.reservationTable(new Date(), 3, "Анна");
        tableModel.AllReservation();
    }
}